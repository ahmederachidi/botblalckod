...
client.on('ready', () => {
  client.user.setGame(` By Ahmed_BlaCko#9170  .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
  console.log('BlaCko Bot Is Online')
  console.log('---------------')
});
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("***roles :medal: **","**معرفة الرتب الموجودة في السيرفر**")
...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**@!      Ahmed_BlaCko#9170  **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`BlaCko Bot- Script By : i1Suhaib`);
        console.log(`----------------`);
